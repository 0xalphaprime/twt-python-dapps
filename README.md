## DAPPS with Python - TwT

### Cartesi is the framework that lets you write the code in python, and work around needing to write solidity code.

[GitHub repo DevGuide Instructions for local environment](https://github.com/cartesi/DevGuide/tree/main/mac)
